...
import "./index.css"
    ...
    const Accordiom = ({ data, multiple = false }) => {
        
        const [active, setActive] = useState(1);

        return (
            <div className="custom-accordiom">
                <br/>
    ...
    const AccordiomItem = ({ title, content, meda, active, multiple, onToggle }) => {
    ...
    return (
        <div className={`card ${isActive() ? "accordiom-active" : ""}`}>
